...
function loadStoreLocator(target) {
    ...
    console.log(`url is :  ${target.data('url')}`)
    $.ajax({
        url: target.data('url'),
        method: 'GET',
        success: function (response) {
            target.html(response.storesResultsHtml);
            console.log(response.storesResultsHtml)
            storeLocator.search();
...
function showStoreFinder(shippingForm) {
    ...
    console.log('reached at showstorefinder function ');
...
function handleInitialSingleship() {
    var pickupSelected = $("#shippingMethods option:selected").data('pickup'); //OK
   // pickupSelected= true;
    var storeSelected = $('.store-details').length;  //OK  //it means alreday selected store is there or not
    storeSelected = null;  
   ...
   console.log(`store finder pickuplselected is  : ${pickupSelected}`);
...
module.exports = {
    watchForInStoreShipping: function () {
        ...
        $('body').on('checkout:updateCheckoutView', function (e, data) {
            console.log('watch for updateCheckoutView');
    ...
    watchForStoreSelection: function () {
        ...
        $('body').on('store:selected', function (e, data) {
            ...
            var card = pickupInStorePanel.parents('.card');
             ...
             // this is scroll button bar waala option that no need in cart page 
    ...
    initialStoreMethodSelected: function () {
        ...
        $(document).ready(function () {
            ...
            if (isMultiship) {
                ...
                console.log('single ship fun will run ');
