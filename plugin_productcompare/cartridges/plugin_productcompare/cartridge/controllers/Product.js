...
server.append('Show', function (req, res, next) {
    ...
    viewData.compareEnabled = true ;//getCategoryCompareStatus(viewData.productSearch);
    viewData.maxSlots = 4 ; // set the max slot to compare as 4 else will get result as null ;
