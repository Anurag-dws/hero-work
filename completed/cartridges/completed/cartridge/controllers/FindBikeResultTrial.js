...
server.post('Show', server.middleware.https,
    function (req, res, next) {
        var findmybikeForm = server.forms.getForm('findmybike'); 
        //  var age_ = req.form.age;
        // var gender_ = req.form.gender;
        //  var height_ = req.form.height;
        //  var category_ = req.form.category; 
        var temp22="cehck";
         var age_ = findmybikeForm.age.htmlValue;
         var gender_ = findmybikeForm.gender.htmlValue;
          var height_ = findmybikeForm.height.htmlValue;
          var category_ = findmybikeForm.category.htmlValue; 
        ...
        res.render('findBikeResultTrial', {
