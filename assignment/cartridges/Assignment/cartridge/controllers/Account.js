...
server.post(
    ...
    function (req, res, next) {
        ...
        //////////////////////////////////
        var qry = req.querystring.rurl ;
        var URLUtils = require('dw/web/URLUtils');
           var temp2 =URLUtils.url('Cart-Show').toString();
            //////////////////////////////////
        if (customerLoginResult.authenticatedCustomer) {
            ...
            //     redirectUrl: temp2
            // });
          //var temp = accountHelpers.getLoginRedirectURL(req.querystring.rurl, req.session.privacyCache, false);
...
server.post('PasswordResetDialogForm', server.middleware.https, function (req, res, next) {
    ...
    if (email) {
        ...
        if (isValid) {
            ...
            res.render('/account/password/resetPasswordSend');
            // res.json({
            //     success: true,
