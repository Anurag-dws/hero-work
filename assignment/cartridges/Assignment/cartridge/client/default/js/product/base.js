...
var essentialsBundle = false;  // will check whether this is an essential bundle of PDP page or not
/**
...
function isEssentialsBundle($el){
  //will check whether this is an essential bundle  of PDP page or not ;
  if($($el).is("[essential]")){
    essentialsBundle=true;
}
return essentialsBundle ;

}
function getPidValue($el) {
   
    var pid;
    //for product set in the single Product detail page ;
...
module.exports = {
    ...
    addToCart: function () {
        $(document).on('click', 'button.add-to-cart, button.add-to-cart-global', function () {
           ...
           //console.log(this);
            ...
            if (essentialsBundle) {
             ...
             var setpid= $($(this)).data('pid');
                $(`.${setpid}`).each(function () {
            ...
            ////////////////////////////////////////////////////////
           else if ($('.set-items').length && $(this).hasClass('add-to-cart-global')) {
                setPids = [];
        ...
        // i have customized getChildProduct by passing the pid of the selected bundle item 
            var form = {
                pid: pid,
                pidsObj: pidsObj,
