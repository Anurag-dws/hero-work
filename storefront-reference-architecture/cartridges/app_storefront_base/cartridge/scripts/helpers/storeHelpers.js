...
function getStores(radius, postalCode, lat, long, geolocation, showMap, url) {
    ...
    var temp = StoreMgr.getStore('hero_store');
    ...
    var location = {};
    geolocation.latitude = 42.833261 ;
    geolocation.longitude = -74.058015 ;
    ...
    //         resolvedRadius
    //     );
    //     var storeMgrResult1 = StoreMgr.searchStoresByPostalCode(
    //         'US',
    //         "22400",
    //         'km',
    //         300
